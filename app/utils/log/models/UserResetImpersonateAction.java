...
public class UserResetImpersonateAction implements LogAction {

	private long impersonate_user_id;

	public UserResetImpersonateAction() {
	}

	public UserResetImpersonateAction(Long impersonate_user_id) {
	...
	public String getDescription() {
		...
		String description = "User ended impersonation of another user ";
